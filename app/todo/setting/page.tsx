...
export default function TodoSettingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      {/* Header */}
      <header className="flex items-center px-4 py-3 border-b sticky top-0 bg-background/95 backdrop-blur z-10">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => router.back()}
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="text-lg font-medium">Avon Yu</h2>
          ...
          <section className="space-y-4">
            ...
            <div className="py-2 flex flex-col space-y-1.5">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-[300px]" align="start">
                  <DropdownMenuItem
                    onClick={() => setBadgeCount("今天到期的逾期")}
                  >
                    今天到期的逾期
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    onClick={() => setBadgeCount("未完成的任务")}
                  >
                    未完成的任务
                  </DropdownMenuItem>
          ...
          <section className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              <Button variant="link" className="justify-start p-0 h-auto text-blue-500">隐私</Button>
              <Button variant="link" className="justify-start p-0 h-auto text-blue-500">导出你的信息</Button>
              <Button variant="link" className="justify-start p-0 h-auto text-blue-500">Microsoft 软件许可条款</Button>
              <Button variant="link" className="justify-start p-0 h-auto text-blue-500">第三方通知</Button>
            </div>
            ...
            <div className="pt-4 space-y-2">
              ...
              <Button variant="link" className="p-0 h-auto text-blue-500">了解有关诊断数据的详细信息</Button>
            </div>
            ...
            <div className="pt-4 space-y-2">
              ...
              <Button variant="link" className="p-0 h-auto text-blue-500">了解有关可选诊断数据的详细信息</Button>
            </div>
          </section>
          ...
          <footer className="pb-10 space-y-1 text-sm text-muted-foreground">
            <h4 className="font-medium text-foreground">Microsoft To Do</h4>
            <p>© 2026 Microsoft. 保留所有权利</p>
            <p>2.153.5851.0</p>
          </footer>
        </div>
      </div>
